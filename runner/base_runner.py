...
import config_learning.utils
import registry_learning.registry
import utils
...
class BaseRunner(metaclass=ABCMeta):
    ...
    def register_hook_from_cfg(self, hook_cfg: Dict) -> None:
        ...
        hook = registry_learning.registry.build_from_cfg(hook_cfg, HOOKS)
    ...
    def resume(self,
        ...
        if 'config' in checkpoint['meta']:
            config = config_learning.utils.Config.fromstring(
    ...
    def register_lr_hook(self, lr_config: Union[Dict, Hook, None]) -> None:
        if lr_config is None:
            ...
            hook = registry_learning.registry.build_from_cfg(lr_config, HOOKS)
        else:
            hook = lr_config
    ...
    def register_momentum_hook(
        ...
        if isinstance(momentum_config, dict):
            ...
            hook = registry_learning.registry.build_from_cfg(momentum_config, HOOKS)
        else:
    ...
    def register_optimizer_hook(
        ...
        if isinstance(optimizer_config, dict):
            ...
            hook = registry_learning.registry.build_from_cfg(optimizer_config, HOOKS)
        else:
    ...
    def register_checkpoint_hook(
        ...
        if isinstance(checkpoint_config, dict):
            ...
            hook = registry_learning.registry.build_from_cfg(checkpoint_config, HOOKS)
        else:
    ...
    def register_logger_hooks(self, log_config: Optional[Dict]) -> None:
        ...
        for info in log_config['hooks']:
            logger_hook = registry_learning.registry.build_from_cfg(
    ...
    def register_timer_hook(
        ...
        if isinstance(timer_config, dict):
            ...
            hook = registry_learning.registry.build_from_cfg(timer_config_, HOOKS)
        else:
            hook = timer_config
